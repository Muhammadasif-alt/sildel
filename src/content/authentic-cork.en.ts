export const authenticCorkEn = {
  ...
  properties: {
    ...
    body:
      "Six qualities make cork unmatched as a luxury material — each born from the structure of its cells.",
    items: [
      {
        title: "Lightweight",
        body: "Half the density of water. Cork floats — and so do the pieces made from it.",
      },
      {
        title: "Impermeable",
        body: "Naturally water and oil resistant — no sealants needed.",
      },
      {
        title: "Fire-resistant",
        body: "Cork chars but does not flame. A natural ember stopper.",
      },
      {
        title: "Hypoallergenic",
        body: "Does not hold dust, mites, or smell. Honest in any room.",
      },
      {
        title: "Sustainable",
        body: "Carbon-negative. Each harvested oak absorbs 3–5× more CO₂ than its neighbors.",
      },
      {
        title: "Durable",
        body: "Cork remembers its shape. Crushed, it recovers — softly.",
      },
    ],
  },
  ...
  inSildel: {
    ...
    points: [
      ...
      "Shaped with hand tools and patience",
      "Finished with natural oils, signed, and numbered",
    ],
  },
  ...
  cta: {
    eyebrow: "Continue",
    title: "See what",
    titleAccent: "the bark becomes.",
    body:
      "Cork is the beginning. The treasures are where the material finds its second life.",
    destinations: [
      {
    ...
    closingLine: "Born in the forest · Finished in Portugal",
  },
};
