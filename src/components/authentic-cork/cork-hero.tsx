...
export function CorkHero() {
  const data = useAuthenticCork().hero;

  return (
    <section
      id="cork-hero"
      className="relative w-full overflow-hidden isolate"
      aria-labelledby="cork-hero-heading"
    >
      {/* Background image */}
      <CorkHeroBackground src={data.image} alt={data.imageAlt} />
...
function CorkHeroBackground({ src, alt }: { src: string; alt: string }) {
