...
/** WhatsApp glyph — lucide ships no brand icons, so inline the official mark. */
...
export function WhatsAppLink({
  ...
  const message = isPt
    ...
    : "Hello Sildel! I saw your website and would like to know more about your pieces.";
  const href = `https://wa.me/${siteConfig.contact.whatsapp}?text=${encodeURIComponent(message)}`;
  const label = isPt ? "Falar connosco no WhatsApp" : "Chat with us on WhatsApp";
