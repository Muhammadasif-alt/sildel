        ...
        {(ctaLabel || ctaSecondaryLabel) && (
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            {ctaLabel && (
              <Link
                href={ctaHref || "#"}
                className="inline-flex items-center bg-foreground px-7 py-4 text-[11px] font-medium uppercase tracking-[0.32em] text-background transition-colors hover:bg-foreground/85"
              >
                {ctaLabel}
              </Link>
            )}
